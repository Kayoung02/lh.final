...
RENEWAL_PROJECTS_PATH = PROCESSED_DIR / "정비사업_추진현황_202606.csv"
COMPANY_ALIAS_MAP_PATH = REFERENCE_DIR / "company_alias_map.csv"
RENEWAL_EVIDENCE_PATH = REFERENCE_DIR / "renewal_builder_evidence.csv"
...
RENEWAL_AREA_SHP_PATH = SPATIAL_DIR / "UPIS_C_UQ181.shp"
